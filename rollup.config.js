...
const legacyConfig = {
  ...
  output: {
    format: 'iife',
    file: 'dist/auro-radio__bundled.es5.js'
  },
  plugins: getSharedPlugins(true)
};

const legacyConfigGroup = {
  input: 'src/es5.js',
  output: {
    format: 'iife',
    file: 'dist/auro-radio-group__bundled.es5.js'
  },
  plugins: getSharedPlugins(true)
};

export default [modernConfig, legacyConfig, legacyConfigGroup];
